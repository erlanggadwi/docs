...
var creatorList = ['@zahirrr','@zhirrrgans','@zhirr_ajalah','@zahiranjay', '@xrlanggasss','@zhirrganteng','@zahirrgantengg'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'xrlangga') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'xrlangga') return res.json(loghandler.invalidKey)
